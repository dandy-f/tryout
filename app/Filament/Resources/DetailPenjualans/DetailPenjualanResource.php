...
use App\Filament\Resources\DetailPenjualans\Pages\ViewDetailPenjualan;
use App\Filament\Resources\DetailPenjualans\Schemas\DetailPenjualanForm;
use App\Filament\Resources\DetailPenjualans\Schemas\DetailPenjualanInfolist;
...
class DetailPenjualanResource extends Resource
{
    ...
    protected static ?string $navigationLabel = ('Sales Details'); // custom label

    protected static ?string $recordTitleAttribute = 'DetailPenjualan';
    ...
    {
        return DetailPenjualanInfolist::configure($schema);
    }
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => ViewDetailPenjualan::route('/{record}'),
